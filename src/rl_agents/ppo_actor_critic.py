"""
PPO Actor-Critic for CDSA-BB3 — NumPy reference implementation (v2).
...
multi-airline pilot consortium simulation. Framework-scale training is planned
under TUBITAK 1001 ARDEB Projects 1+2 (Faz B).
"""
...
class PPOActorCritic:
    ...
    def __init__(self, fused_dim: int = 64, n_actions: int = 4,
